...
def setup_env():
    ...
    openai_key = input("Enter your OPENAI_API_KEY (or press Enter to skip/keep existing): ").strip()
    grok_key = input("Enter your GROK_API_KEY (or press Enter to skip/keep existing): ").strip()
